...
# Clean Data (using in-memory data)
...
# Merge, Flag Original Data, and Impute
message("analysis.R: Merging and imputing")
merged_df <- df_cold %>%
...
# Calculate National Monthly Statistics (Baseline)
...
# RESEARCH QUESTION 1: EDA FOR DRASTIC VARIATIONS 
message("analysis.R: Defining RQ1 plots")

# Function to Create Boxplot with Max/Min Highlights
...
# Function to Create Bubble/Scatter Plot with Max Highlights
...
# Calculate Composite Hotspot Index (H)
...
# Plot Final Hotspot Index Bar Plot
...
# Define Plotting function for Correlation Heatmap
...
# Rank and select the top 10 anomalies
top_10_anomalies <- df_long_anom %>%
  arrange(desc(Abs_Z_Score)) %>%
  head(10)

# Create Plotting Function for Contextual Line Plot
...
# Function to plot the Nth anomaly
